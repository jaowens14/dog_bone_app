...
class Dogbone(ft.UserControl):
    def __init__(self, dog_bone_number):
        super().__init__()
        self.dog_bone_number = dog_bone_number

    def build(self):
        self.file_path =  ft.TextField(hint_text="Path to dog bone file")
        self.number =     ft.TextField(value = "Dog Bone Number")
        self.length =     ft.TextField(value = "Length")
        self.width =      ft.TextField(value = "Width")
        self.thickness =  ft.TextField(value = "Thickness")
        self.elongation = ft.TextField(value = "Elongation")
        self.load =       ft.TextField(value = "Load")
        print("Here")
        self.display_view = ft.Row(
            alignment=ft.MainAxisAlignment.SPACE_BETWEEN,
            vertical_alignment=ft.CrossAxisAlignment.CENTER,
            controls=[
                self.file_path, self.number,
                ft.Row(
                    spacing=0,
                    controls=[
                        ft.IconButton(
